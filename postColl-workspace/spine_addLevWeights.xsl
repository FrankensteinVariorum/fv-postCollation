...
<xsl:stylesheet xmlns:tei="http://www.tei-c.org/ns/1.0"
    ...
    xmlns:th="http://www.blackmesatech.com/2017/nss/trojan-horse" exclude-result-prefixes="xs tei"
    version="3.0">
    <!--2018-10-24 updated 2019-03-16 and 2019-07-03 ebb: This stylesheet maps the maximum Levenshtein distance value for each app onto the spine files. Run this over FV_LevDists-weighted.xml (the XML generated by the Python script that calculates Levenshtein distances at each app location and stores them in feature structures.) 
        Note: We may or may not wish to run the LevWeight-Simplification.xsl beforehand (which would remove comparisons with "0" at gap or cut locations where one or more witnesses are not present). 
